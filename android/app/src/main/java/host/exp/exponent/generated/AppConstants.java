...
public class AppConstants {
  ...
  public static String INITIAL_URL = "exp://exp.host/@welyco-dev/expo-signed-android-app-image-problem";
  public static final String SHELL_APP_SCHEME = "exp0faa4c1a8a8442398afc5b1b7e3dc3c3";
  ...
  static {
    List<Constants.EmbeddedResponse> embeddedResponses = new ArrayList<>();
        ...
        embeddedResponses.add(new Constants.EmbeddedResponse("https://exp.host/@welyco-dev/expo-signed-android-app-image-problem", "assets://shell-app-manifest.json", "application/json"));
        embeddedResponses.add(new Constants.EmbeddedResponse("https://d1wp6m56sqw74a.cloudfront.net/%40welyco-dev%2Fexpo-signed-android-app-image-problem%2F1.0.0%2F9d061bfba269480cafe3f0195906ea0b-32.0.0-android.js", "assets://shell-app.bundle", "application/javascript"));
